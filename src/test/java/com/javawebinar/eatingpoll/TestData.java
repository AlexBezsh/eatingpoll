...
public class TestData {
    ...
    public static final User MOCK_USER1 = new User(1L, "User1", "user1@gmail.com", "dXNlcjE=", Role.USER, null);
    public static final User MOCK_USER2 = new User(2L, "User2", "user2@gmail.com", "dXNlcjI=", Role.USER, null);
    public static final User MOCK_ADMIN1 = new User(3L, "Admin1", "admin1@gmail.com", "YWRtaW4x", Role.ADMIN, null);
